        ...
        return (
            <View style={{ flex: 1 }} >
                <ScrollView>
                    ...
                    <Text style={{ fontStyle: 'italic' }}>Med trädgårdskalendern håller du koll på vad som behöver göras i trädgården månad för månad.</Text>
                    <Image
                    ...
                    />
                        ...
                        <Text>Under våren och försommaren är tillväxten 
                        ...
                        <Text>De sommarblommor du själv sått eller köpt som färdiga plantor börjar längta utomhus.
